...
// NewModel creates a new Model from struct T's tags.
//
...
func NewModel[T any](tableName string, optFns ...func(*MapOpts)) (*Model[T], error) {
...
// Model contains metadata about items in a DynamoDB table computed from struct tags.
